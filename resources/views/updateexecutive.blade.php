    ...
    <div class="row col-md-6 col-md-offset-3">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ url('listexecutive') }}" class="btn float-end">
                        <i class="fa-solid fa-circle-left" style="font-size: 24px;" title="Back"></i>
                    </a>
                                    <!-- </div>
            </div> -->

            <div class="container m-2">
  <form action="{{ url('updateexecuteRoute/'.$user->eeid) }}" method="post" required>
  ...
  @csrf
                    ...
                    <div class="row m-2">
                        ...
                        <select class="form-control" name="subname" id="exname_categary"  style='width:100px;'>
                                    ...
                                    <option value="mis" {{ $user->subname == 'mis' ? 'selected' : '' }}>Mrs</option>
                                </select>
        ...
        @endforeach
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                        <input type="tel" name="phone_no" class="form-control" placeholder="123 456 7890" id="phone" onkeyup="validatephone()" value="{{ $user->phone_no ?? '' }}">                        </div>
                    </div>
