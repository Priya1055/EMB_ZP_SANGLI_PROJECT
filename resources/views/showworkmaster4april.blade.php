...
<div class="row">
    ...
    <div class="col-12 col-md-3">
        <div class="form-group">
            ...
            <input type="text" id="EE_Name" disabled name="EE_Name" class="form-control" value="{{$DBEENAME}}">        </div>
    </div>
    ...
    <div class="col-12 col-md-3">
        <div class="form-group">
            ...
            <input type="text" id="DyE_Name" name="DyE_Name" disabled class="form-control" value="{{$DBDYENAME}}">        </div>
    </div>
    ...
    <div class="col-12 col-md-3">
        <div class="form-group">
            ...
            <input type="text" id="SO_Name" name="SO_Name" disabled class="form-control" value="{{$DBSONAME}}">        </div>
    </div>
