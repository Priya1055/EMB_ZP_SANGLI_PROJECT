    ...
    <div class="row col-md-6 col-md-offset-3">
            ...
            <div class="card">
                <div class="card-header">
                    <!-- <a href="{{ url('listsdc') }}" class="btn btn-danger float-end">BACK</a> -->
                    <a href="{{ url('listSDC') }}" class="btn  float-end"><i class="fa-solid fa-circle-left" style="font-size: 24px;"></i> </a>
        ...
        <div class="col-md-6">
<input type ="text" class="form-control" name="division_name" id="divname" value="{{$Div->div ?? ''}}" disabled >
            </div>
</div>
        ...
        <input type="text" class="form-control" name="subdivision_name" id="divname"  value="{{$SubDiv->Sub_Div ?? ''}}" disabled>
            </div>
</div>
            ...
            <div class="row m-2">
        <div class="col-md-5">
            <label class="" for="exe_name"> SDC Name:</label>
            </div>

            <div class="col-md-6">
                <input class="form-control" name="dename_categary" id="" style='width:60px;' disabled value="{{$user->subname ?? ''}}">
                <input type="text" class="form-control" name="dpt_name" id="name" required  disabled value="{{$user->name ?? ''}}"  >
             </div>
</div>
<div class="row m-2">
        <div class="col-md-5">
            <label class="" for="exe_name"> SDC Name Marathi:</label>
            </div>

            <div class="col-md-6">
                <input class="form-control" name="dename_categary" id="" style='width:60px;' disabled value="{{$user->name_m ?? ''}}">
             </div>
</div>
        ...
        <div class="col-md-5">
            ...
            <input type="date"  class="form-control" disabled
             name="charge_upto" required id="charge_upto" onkeyup="validatedateupto()"   value="{{$user->period_upto ?? ''}}">
             </div>
</div>
...
<div class="row m-2">
        ...
        <div class="col-md-5">
            ...
            id="phone" onkeyup="validatephone()" value="{{$user->username ?? ''}}"  disabled>
            </div>
...
<!-- </div> -->
            ...
            <a href="{{url('listSDC')}}" class="btn btn-primary ">Exit</a>
