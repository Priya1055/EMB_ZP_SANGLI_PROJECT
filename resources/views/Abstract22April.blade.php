        ...
        <form action="" method="post">
          @csrf
            <div class="form-group form-row align-items-center">
              ...
              <div class="col-md-4">
              <input type="text" name="workid" class="form-control" id="workid"  value="{{$DBEMBdetails->Work_Id ?? ''}}" required >
              </div>
              
                            <label for="sectionengineer" class="col-md-2">Section Engineer:</label>
              <div class="col-md-4">
              <input type="text" class="form-control" id="sectionengineer" name="name" value="{{ $DBSectionEngNames ? $DBSectionEngNames : '' }}" disabled>
              </div>
