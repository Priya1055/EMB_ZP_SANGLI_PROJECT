...
@endauth  -->
                    ...
                    <table class="table table-striped"  >
                        ...
                        @foreach($billdata as $bill)
                           ...
                           <form action="{{ url('viewbill' , ['id' =>$bill->t_bill_Id ])}}" method="GET">
                                  ...
                                  <button type="submit" class="btn btn-primary mb-2"    title=" EDIT BILL">
   ...
   {{ $bill->is_current === 0 ? 'disabled' : '' }} title="DELETE BILL">
    <i class="fa fa-trash" aria-hidden="true"></i>
                                  ...
                                  <button type="submit" class="btn btn-danger mb-2"   title="DELETE BILL">
                                      <i class="fa fa-trash" aria-hidden="true"></i>
                                  </button>
                                ...
                                <form method="post" action="{{ url('updatematerialcon') }}" >
                                    ...
                                    <button type="submit" class="btn btn-primary btn-sm mb-2" >Material consumption
                                    </button>
                                    @endif
                                </form>
                                @endif
                                  ...
                                  <form method="get" action="{{ url('ListRecoveryStatement') }}" >
                                    ...
                                    <input type="hidden" name="t_bill_Id" value="{{ $bill->t_bill_Id }}">
                                    <button type="submit" class="btn btn-primary btn-sm mb-2" >Recovery</button>
                                    @endif
                                  </form>
                                  @endif
                                  ...
                                  <form action="{{ url('ExcessStatement' , ['id' =>$bill->t_bill_Id ])}}" method="GET">
                                   ...
                                   <button type="submit" class="btn btn-primary mb-2 "  title="EXCESS">
      ...
      <!--</form>-->
        ...
        <button type="button" class="btn btn-primary btn-sm mb-2" onclick="uploadimages();" id="imgButton"  title="UPLOAD IMG DOC VDO"><i class="fa fa-upload" aria-hidden="true"></i> Photo/Docs/Video</button>
        @endif
         </div>
      @endif
...
<form action="{{ url('Abstract' , ['id' =>$bill->t_bill_Id ])}}" method="GET">
                                   ...
                                   <button type="submit" class="btn btn-primary mb-2 ml-1"  title="Abstract">
