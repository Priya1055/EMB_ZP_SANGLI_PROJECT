...
<div class="container">
  ...
  @csrf
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                        <select class="form-control" name="division_name" id="divname" disabled>
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                        <select class="form-control" name="subname" id="exname_categary"  style='width:100px;' disabled>
                                ...
                                <input type="text" class="form-control" name="ex_name" id="name" disabled value="{{ $user->name ?? '' }}">                        </div>
                    </div>
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="exname_categary" id="exname_categary" style='width:100px;' disabled>
                                <option value="mr">Mr</option>
                                <option value="miss">Miss</option>
                                <option value="mis">Mrs</option>
                            </select>
                            <input type="text" class="form-control" name="ee_name_M" id="ee_name_M" disabled value="{{ $user->name_m ?? '' }}">                        </div>
                    </div>
        ...
        @endforeach
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                        <input type="date" class="form-control" name="charge_from" id="addre1" onkeyup="validateName()" value="{{ $user->period_from ?? '' }}" disabled>                        </div>
                    </div>
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                        <input type="date" class="form-control" name="charge_upto"  id="addre2" onkeyup="validateadd()" value="{{ $user->period_upto ?? '' }}" disabled>                        </div>
                    </div>
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                        <input type="text" name="PF_no" class="form-control" id="phone" onkeyup="validatephone()" value="{{ $user->pf_no ?? '' }}" disabled>
                       </div>
                        </div>
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                        <input type="tel" name="phone_no" class="form-control" placeholder="123 456 7890" id="phone" onkeyup="validatephone()" value="{{ $user->phone_no ?? '' }}" disabled>
                      </div>
                    </div>
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                        <input type="email" name="email" class="form-control" id="mail" onkeyup="validateemail()" value="{{ $user->email ?? '' }}" disabled>                        </div>
                    </div>
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                        <input type="tel" name="user_name" class="form-control" placeholder="" id="phone" onkeyup="validatephone()" value="{{ $user->username ?? '' }}" disabled>                        </div>
                    </div>
