...
<div class="container-fluid">
    <div class="row">
      ...
      <div class="step complete" data-step-value="1">Material Consumption  
        <div class="node"></div></div>  
        <div class="step complete" data-step-value="2">Recovery
        <div class="node"></div></div>
        <div class="step complete" data-step-value="3">Excess Saving
        <div class="node"></div></div>
        <div class="step complete" data-step-value="4"> Royalty Charges
        <div class="node"></div></div>
        <div class="step complete" data-step-value="5">Photo/Doc/Video
        <div class="node"></div></div>
        <div class="step complete" data-step-value="6"> Abstract
        <div class="node"></div></div>
        <div class="step complete" data-step-value="7">MB Checked/Submited
        <div class="node"></div></div>
</div><br>
...
@endauth  -->
                    ...
                    <table class="table table-striped"  >
                        ...
                        @foreach($billdata as $bill)
                           ...
                           <form action="{{ url('viewbill' , ['id' =>$bill->t_bill_Id ])}}" method="GET">
                                  ...
                                  @if(auth()->user()->usertypes === "SO" &&  (int)$mbstatus <= 12)
   ...
   {{ $bill->is_current === 0 ? 'disabled' : '' }} title="DELETE BILL">
    <i class="fa fa-trash" aria-hidden="true"></i>
                                  ...
                                  @if(auth()->user()->usertypes === "SO" && in_array($mbstatusSo, [0,1,2, 3, 4,5,6,7] ) && (int)$mbstatus == 2)
                                ...
                                @endif
                                  ...
                                  @if(auth()->user()->usertypes === "SO" && in_array($mbstatusSo, [1,2, 3, 4,5,6,7]) && (int)$mbstatus == 2)
                                  ...
                                  @if(auth()->user()->usertypes === "SO" && in_array($mbstatusSo, [ 2,3,4,5,6,7]) && (int)$mbstatus == 2)
                                  ...
                                  @if(auth()->user()->usertypes === "SO" && in_array($mbstatusSo, [3,4,5,6,7]) && (int)$mbstatus == 2)
                        ...
                        <div class="inline">
                        @if(auth()->user()->usertypes === "SO" && in_array($mbstatusSo, [4,5,6,7])&& (int)$mbstatus == 2)
      ...
      <!--</form>-->
        ...
        <button type="button" class="btn btn-primary btn-sm mb-2" onclick="uploadimages();" id="imgButton" {{$bill->is_current === 0 ? 'disabled' : ''}} title="UPLOAD IMG DOC VDO"><i class="fa fa-upload" aria-hidden="true"></i> Photo/Docs/Video</button>
         </div>
      @endif
...
<form action="{{ url('Abstract' , ['id' =>$bill->t_bill_Id ])}}" method="GET">
                                     @csrf
                                   <button type="submit" class="btn btn-primary mb-2 ml-1" {{$bill->is_current === 0 ? 'disabled' : ''}} title="Abstract">
...
<a href="{{ url('emb', ['id' => $bill->t_bill_Id]) }}"  class="btn btn-primary mb-2 {{$bill->is_current === 0 ? 'disabled' : ''}}"  title="EDIT BILL">
    EMB<i class="fa fa-pencil" style="color:white;"></i>
</a>
...
<a href="{{ url('report', ['id' => $bill->t_bill_Id]) }}" class="btn btn-primary mb-2" title="REPORT">
                          ...
                          <!-- {{$bill->t_bill_Id}} -->
                          @if(auth()->user()->usertypes === "DYE" &&  $mbstatus===8) 
                          <div class="d-flex justify-content-center align-items-center" >
                          ...
                          @if(auth()->user()->usertypes === "PO" &&  $mbstatus===9) 
                          <div class="d-flex justify-content-center align-items-center" >
                          ...
                          @if(auth()->user()->usertypes === "audit" &&  $mbstatus===10) 
                          <div class="d-flex justify-content-center align-items-center">
                ...
                @if(auth()->user()->usertypes === "AAO" &&  $mbstatus===11) 
                <div class="d-flex justify-content-center align-items-center">
                ...
                @if(auth()->user()->usertypes === "EE" &&  $mbstatus===12) 
                <div class="d-flex justify-content-center align-items-center">
