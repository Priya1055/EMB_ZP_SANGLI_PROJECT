                                                                    ...
                                                                    <div class="modal-body">
                                                                            <div class="row mt-3"> <!-- Adding margin top (mt-3) for some spacing -->
                                                                                ...
                                                                                <div class="col-md-8 mb-5">
                                                                                        <input type="hidden" name="unique_id" id="unique_id_{{ $item->unique_id }}" value="{{ $item->unique_id }}">
                                                                            ...
                                                                            <h5 class="table-success">As per Tender:</h5>
                                                                                <!-- </div> -->
                                                                                    <div class="row mt-1">
                                                                                        <div class="col-md-3 ml-5">
                                                                                            ...
                                                                                            <input type="text" class="form-control UpdateAsperQty" onchange="calculateAmount('{{ $item->unique_id }}')" id="UpdateAsperQty{{ $item->unique_id }}" name="UpdateAsperQty"  placeholder="Enter Quantity...">        
                                                                                        </div>
                                                                                        <div class="col-md-3 ml-5">
                                                                                    ...
                                                                                    <!-- <div class="row mt-3"> -->
                                                                                                <h5 class="table-success mt-2">Up-to-date Issue:</h5>
                                                                                    <!-- </div> -->
                                                                                ...
                                                                                <!-- <div class="row mt-3"> -->
                                                                                <h5 class="table-success mt-2">Already Recovered:</h5>
                                                                            <!-- </div> -->
                                                                                <div class="row mt-3">
                                                                                    <div class="col-md-3 ml-5">
                                                                                        <label for="" class="col-form-label font-weight-bold">Quantity:</label>
                                                                            ...
                                                                            <!-- <div class="row mt-3"> -->
                                                                                <h5 class="table-success mt-2">Proposed to be Recovered Now:</h5>
                                                                        <!-- </div> -->
                                                                            <div class="row mt-1">
                                                                                <div class="col-md-3 ml-5">
                                                                                    <label for="" class="col-form-label font-weight-bold">Quantity:</label>
                                                                            ...
                                                                            <!-- <div class="row mt-3"> -->
                                                                                <h5 class="table-success mt-2">Balance to be Recovered: </h5>
                                                                        <!-- </div> -->
                                                                            <div class="row mt-3">
                                                                                <div class="col-md-3 ml-5">
                                                                                    <label for="" class="col-form-label font-weight-bold">Quantity:</label>
