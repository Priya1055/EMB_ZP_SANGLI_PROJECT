...
<br>
  ...
  <div class="title">FUND HEAD </div>
    <div class="container">
        <div class="m-2">
        <form action="{{url('updatefundhead/' . $editfundhead->F_H_CODE)}}" method="post" >
    @csrf
    @method('PUT')
    ...
    <div class="row m-2 mb-5">
        ...
        <div class="col-md-4">
            <input type="text" name="fhcode" id="fundheadcode" class="form-control" value="{{$editfundhead->F_H_CODE ?? ''}}" required>
        </div>
    </div>
    <div class="row m-2 mb-5">
        <div class="col-md-3">
        ...
        <div class="col-md-4">
            <input type="text" name="fundhead" id="fundhead" class="form-control" value="{{$editfundhead->Fund_Hd ?? ''}}" required>
        </div>
    </div>
    <div class="row m-2 mb-5">
        <div class="col-md-3">
        ...
        <div class="col-md-4">
            <input type="text" name="fundhead_m" id="fundheadmarathi" class="form-control" value="{{$editfundhead->Fund_Hd_M ?? ''}}" required>
        </div>
    </div>
