...
<div class="container-fluid" >
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="{{ url('deputychecklist', $embsection2->t_bill_Id ?? '') }}">Division Checklist Report</a></li>
        </ul>
        ...
        <!-- Report Tabluler Body -->
            ...
            <a class="btn btn-primary" style="background-color: #ffb7b5; color:black; font-weight:bold; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3);" href="{{ url('DivisionChecklistpdf', $embsection2->t_bill_Id ?? '') }}">Export to PDF</a>
        </div>
