...
.padded-actual_complete_date
 {
    ...
    animation: moveLeftToRight 10s linear infinite; /* Adjust duration here */
    margin-bottom: 5px;
}
...
<div class="container-fluid">
    ...
    <div>
        <a href="{{url('viewfindworkmaster')}}" class="btn" style="margin-right:10px;"><i class="fa-solid fa-magnifying-glass fa-2xl" style="color: #63E6BE;" data-toggle="tooltip" title="Find Workid"></i><b></b></a>
        <!-- //new button ajax -->
        <!-- <a class="btn btn-primary btn-lg" id="newButton">New</a> -->
        @if(auth()->user()->usertypes === "SO")
        <a class="btn" style="bgcolor: #5783db;" id="newButton" onclick="NewWorkIdCreated(null)" ><i class="fa-solid fa-plus fa-2xl" style="color: #B197FC;" data-toggle="tooltip" title="New Workid Create"></i><b></b></a>
        @endif
        <!-- //new button ajax -->
    </div>
</div>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                           ...
                           <td>{{ $user->Tot_Exp }}</td>
                                ...
                                <td>
                                <a href="{{url('showworkmaster/' . $user->Work_Id)}}" style="border-right: 1px solid black; outline: none; display: block; margin-top:5px; border-right: 1px solid black;"><i class="fa fa-eye custom-icon fa-xl" data-toggle="tooltip" title="View Workmaster" style="color: black;"></i><b></b></a>
...
<a  style="display: block; margin-top:50px; border: none; cursor: pointer;" onclick="NewWorkIdCreated('{{ $user->Work_Id }}')">
            <i class="fa-solid fa-plus fa-2xl" style="color: #B197FC;" data-toggle="tooltip" title="Add tender items"></i><b></b>
</a>
        @else    
        
        
        <a href="{{url('billlist/' . $user->Work_Id)}}" style="display: block; margin-top:50px;"><i class="fa-solid fa-file-invoice fa-xl" style="color: black;" data-toggle="tooltip" title="BILLS"></i><b></b></a>
@endif
...
<form method="POST" action="{{ route('users.delete', ['Work_Id' => $user->Work_Id]) }}" style="border: none;">
    ...
    <a type="submit" class="show-alert-delete-box" style="margin-left:50px;"   
        data-work-id="{{ $user->Work_Id }}"><i class="fa fa-trash fa-xl" aria-hidden="true"  data-toggle="tooltip" title="Delete"  style="color: red;"></i></a>
</form>
@endif
@endauth  
