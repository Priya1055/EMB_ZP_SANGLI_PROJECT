...
.spinner {
    ...
    border: 8px solid rgba(0, 0, 0, 0.1); /* Increased border size */
    border-left-color: #0728af; /* Blue color */
    border-radius: 50%;
    width: 120px; /* Increased width */
    height: 120px; /* Increased height */
    animation: spin 1s linear infinite;
    z-index: 9999;
    /* You can add additional styling to make it more attractive */
...
<div class="card" id="backbglogo">
  ...
  @auth 
      ...
      @if(auth()->user()->usertypes === "SO" &&  ($mbstatusSo >= 6 && $mbstatus == 2)) 
      ...
      @if(auth()->user()->usertypes === "DYE"  &&  (int)$mbstatus===3)
      ...
      @if(auth()->user()->usertypes === "EE" &&  (int)$mbstatus===4              )   
      ...
      @if(auth()->user()->usertypes === "Agency" &&  (int)$mbstatus===5) 
              <div class="d-flex justify-content-center align-items-center" >
                  ...
                  @if(auth()->user()->usertypes === "SO" && $mbstatus <= 2) 
                      <div class="button-container">
                          <div style="display: inline-block;">
                            <button type="button" class="btn btn-primary" onclick="displayFinalBillAlert(<?php echo $embsection2->final_bill; ?>)" title="ADD TENDER ITEM" id="addtender">
                      ...
                      @foreach($embsection3 as $item)
                              ...
                              <td>{{ $item->b_item_amt }}</td>
                                  ...
                                  <button type="button" class="btn emb-button mb-2" data-toggle="modal" data-target="#embview{{ $item->b_item_id }}" onclick="openModal('{{ $item->b_item_id }}')" title="VIEW MEASUREMENTS">
                                      ...
                                      <button type="button" class="btn btn-danger mb-2" onclick="deletebillitem('{{ $item->b_item_id }}')" {{ (int)$item->is_previous === 0 ? 'disabled' : '' }} {{ $embsection2->is_current === 0 ? 'disabled' : '' }} title="DELETE TENDER ITEM">
                            ...
                            <div class="modal fade" id="embeditbutton${billitem}" data-backdrop="static" role="dialog" aria-labelledby="exampleModalLabeledit${billitem}" data-modal-type="parent" aria-hidden="true">
                                  <div class="modal-dialog modal-fullscreen" role="document">
                                          ...
                                          <div class="modal-body" id="normaldata${billitem}">
                                              <div class="table-responsive">
                                                  <table class="table table-bordered table-striped">
                                                      <thead>
                                                          <tr>
                                    <th style="width: 2%;">Sr_No</th>
                                    <th style="width: 20%;">Particulars</th>
                                    <th style="width: 7%;">Number</th>
                                    <th style="width: 5%;">Length</th>
                                    <th style="width: 5%;">Breadth</th>
                                    <th style="width: 5%;">Height</th>
                                    <th style="width: 20%;">Formula</th>
                                    <th style="width: 12%;">Quantity</th>
                                    <th style="width: 12%;">Date of Measurement</th>
                                    <th style="width: 1%;">Not for Payment</th>
                                    <th style="width: 15%;">Action</th>
                                            ...
                                            <tr >
                                            <td colspan="7" style="text-align:right;"  class="text-right"><label for="currentQty" class="font-weight-bold">Current Quantity:</label></td>
                                            <td ><input type="text" class="form-control" id="currentQty${billitem}" name="currentQty" disabled style="text-align:right"></td>
                                            <td colspan="3"></td>
                                            </tr>
                                            <tr>
                                            <td style="text-align:right;" colspan="7" class="text-right"><label for="previousQty" class="font-weight-bold">Previous bill Quantity:</label></td>
                                            <td><input type="text" class="form-control" id="previousQty${billitem}" name="previousQty" disabled style="text-align:right"></td>
                                            <td colspan="3"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align:right;" colspan="2"><label for="tndqty" class="font-weight-bold">Tender Quantity Of Item:</label></td>
                                                <td  colspan="1"><input type="text" class="form-control" id="tndqty${billitem}" name="tndqty" disabled style="text-align:right"></td>
                                                <td style="text-align:right;" ><label for="percentage" class="font-weight-bold">Percentage Utilised:</label></td>
                                                <td colspan="2"><input type="text" class="form-control" id="percentage${billitem}" name="percentage" disabled style="text-align:right"></td>
                                                <td style="text-align:right;" ><label for="totalQty" class="font-weight-bold">Total Uptodate Quantity:</label></td>
                                                <td><input type="text" class="form-control" id="totalQty${billitem}" name="totalQty" disabled style="text-align:right"></td>
                                                <td colspan="3"></td>
                                            </tr>
                                            <tr>
                                                <td  colspan="2" style="text-align:right;"><label for="tndcost" class="font-weight-bold">Tender Cost Of Item:</label></td>
                                                <td  colspan="1"> <input type="text" class="form-control" id="tndcost${billitem}" name="tndcost" disabled style="text-align:right"></td>
                                                <td style="text-align:right;"> <label for="costdifference" class="font-weight-bold">Excess/Saving:</label></td>
                                                <td colspan="2" ><input type="text" class="form-control" id="costdifference${billitem}" name="costdifference" disabled style="text-align:right"></td>
                                                <td style="text-align:right;" ><label for="totalcost" class="font-weight-bold" >Total Uptodate Amount:</label></td>
                                                <td><input type="text" class="form-control" id="totalcost${billitem}" name="totalcost" disabled style="text-align:right"></td>
                                                <td colspan="3"></td>
                                            </tr>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="row">
                                      <div class="col-md-3 form-group">
                                        ...
                                        <input type="text" class="form-control" id="newparticulars${billitem}" name="Particulars" style="text-align: left;">
                                      </div>
                                      <div class="col-md-2 form-group">
                                        <label for="number" class="font-weight-bold">Number:</label>
                                        <input type="number" class="form-control"  id="newnumber${billitem}"  oninput="newupdateQuantity('${billitem}')" name="Number" style="text-align: left;">
                                      </div>
                                      <div class="col-md-2 form-group">
                                        <label for="len" class="font-weight-bold">Length:</label>
                                        <input type="number" class="form-control"  id="newlength${billitem}"  oninput="newupdateQuantity('${billitem}')" name="Length" style="text-align: left;">
                                      </div>
                                      <div class="col-md-2 form-group">
                                        <label for="brea" class="font-weight-bold">Breadth:</label>
                                        <input type="number" class="form-control"  id="newbreadth${billitem}"  oninput="newupdateQuantity('${billitem}')" name="Breadth" style="text-align: left;">
                                      </div>
                                      <div class="col-md-2 form-group">
                                        <label for="hei" class="font-weight-bold">Height:</label>
                                        <input type="number" class="form-control"  id="newheight${billitem}"  oninput="newupdateQuantity('${billitem}')" name="Height" style="text-align: left;">
                                      </div>
                                      <div class="col-md-1 form-group">
                                        <label for="Quantity" class="font-weight-bold">Quantity:</label>
                                        <input type="text" class="form-control"  id="newquantity${billitem}"  oninput="newupdateQuantity('${billitem}')" name="Quantity" disabled style="text-align: left;">
                                      </div>
                                </div>
                                ...
                                <div class="row">
                                  <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" data-id="${billitem}" id="newformula${billitem}" oninput="newupdateQuantity('${billitem}')" name="Formula" style="text-align: left;">
                                  </div>
                                </div>
                                  ...
                                  <div class="modal-bodyview" id="normalview${billitem}">
                                      <div class="table-responsive">
                                          <table class="table table-bordered table-striped">
                                              <thead>
                                                  <tr>
                                    <th id="sr-no" style="width: 1%;">Sr_No</th>
                                    <th id="particulars" style="width: 20%;">Particulars</th>
                                    <th id="Number" style="width: 7%;">Number</th>
                                    <th id="length" style="width: 5%;">Length</th>
                                    <th id="breadth" style="width: 3%;">Breadth</th>
                                    <th id="height" style="width: 3%;">Height</th>
                                    <th id="formula" style="width: 20%;">Formula</th>
                                    ...
                                    <th id="date-of-measurement">Date of Measurement</th>            
                                              ...
                                              <tr >
                                            <td colspan="7" style="text-align:right;"  class="text-right"><label for="previousQty" class="font-weight-bold">Previous bill Quantity:</label></td>
                                            <td >  <input type="text" class="form-control" id="viewpreviousQty${billitem}" name="previousQty"  disabled style="text-align:right"></td>
                                            <td colspan="3"></td>
                                            </tr>

                                            <tr>
                                            <td style="text-align:right;" colspan="7" class="text-right"><label for="currentQty" class="font-weight-bold">Current Quantity:</label></td>
                                            <td> <input type="text" class="form-control" id="viewcurrentQty${billitem}" name="currentQty"  disabled style="text-align: right;"></td>
                                            <td colspan="3"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align:right;" colspan="2"><label for="tndqty" class="font-weight-bold">Tender Quantity Of Item:</label></td>
                                                <td  colspan="1"><input type="text" class="form-control" id="viewtndqty${billitem}" name="tndqty"  disabled style="text-align:right"></td>
                                                <td style="text-align:right;" >  <label for="percentage" class="font-weight-bold">Percentage:</label></td>
                                                <td colspan="2"> <input type="text" class="form-control" id="viewpercentage${billitem}" name="percentage"  disabled style="text-align:right"></td>
                                                <td style="text-align:right;" ><label for="totalQty" class="font-weight-bold">Total Uptodate Quantity:</label></td>
                                                <td> <input type="text" class="form-control" id="viewtotalQty${billitem}" name="totalQty"  disabled style="text-align:right"></td>
                                                <td colspan="3"></td>
                                            </tr>
                                            <tr>
                                                <td  colspan="2" style="text-align:right;"> <label for="tndcost" class="font-weight-bold">Tende Cost Of Item:</label></td>
                                                <td  colspan="1">  <input type="text" class="form-control" id="viewtndcost${billitem}" name="tndcost"  disabled style="text-align:right"></td>
                                                <td style="text-align:right;">    <label for="costdifference" class="font-weight-bold">Cost Difference:</label></td>
                                                <td colspan="2" >  <input type="text" class="form-control" id="viewcostdifference${billitem}" name="costdifference"  disabled style="text-align:right"></td>
                                                <td style="text-align:right;" > <label for="totalcost" class="font-weight-bold">Total Cost of Item:</label></td>
                                                <td> <input type="text" class="form-control" id="viewtotalcost${billitem}" name="totalcost"  disabled style="text-align:right"></td>
                                                <td colspan="3"></td>
                                            </tr>
  ...
  @auth 
    ...
    @if(auth()->user()->usertypes === "SO" &&  ($mbstatusSo >= 6 && (int)$mbstatus == 2)) 
  ...
  <div class="modal-dialog  modal-fullscreen" role="document">
    ...
    <div class="row">
        <div class="col-md-3 form-group">
            ...
            <img id="previewPhoto1" src="" alt="Preview Photo 1" style="max-width: 100px; max-height: 100px; cursor: pointer;"
                data-toggle="modal" data-target="#imageModal" data-image="previewPhoto1">
        </div>
        <div class="col-md-3 form-group">
            ...
            <img id="previewPhoto2" src="" alt="Preview Photo 2" style="max-width: 100px; max-height: 100px; cursor: pointer;"
                data-toggle="modal" data-target="#imageModal" data-image="previewPhoto2">
        </div>
        <div class="col-md-3 form-group">
            ...
            <img id="previewPhoto3" src="" alt="Preview Photo 3" style="max-width: 100px; max-height: 100px; cursor: pointer;"
                data-toggle="modal" data-target="#imageModal" data-image="previewPhoto3">
        </div>
        <div class="col-md-3 form-group">
            ...
            <img id="previewPhoto4" src="" alt="Preview Photo 4" style="max-width: 100px; max-height: 100px; cursor: pointer;"
                data-toggle="modal" data-target="#imageModal" data-image="previewPhoto4">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-3 form-group">
            ...
            <img id="previewPhoto5" src="" alt="Preview Photo 5" style="max-width: 100px; max-height: 100px; cursor: pointer;"
                data-toggle="modal" data-target="#imageModal" data-image="previewPhoto5">
        </div>
    ...
    <div class="video-container" style="width: 250px; height: 240px; overflow: hidden;">
       ...
       <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="imagedocupload()">Upload</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="tndItemModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="tndItemModalLabel" aria-hidden="true">
  ...
  <div class="form-check col-10">
    <input type="checkbox" class="form-check-input" id="alltenderitem" name="alltenderitem" value="" <?php echo ($embsection2->final_bill == 1) ? 'disabled' : ''; ?>>
    <label class="form-check-label mr-3" for="alltenderitem" style="margin-left:15px;"><?php echo ($embsection2->final_bill == 1) ? 'ALL TENDER ITEM' : 'ALL TENDER ITEM'; ?></label>
</div>
  ...
  //console.log(billitemid);
    $.ajax({
        ...
        // console.log("Document URL:", documentUrls);
                ...
                var row = $('<tr>');
                row.append($('<td>').text(modaldata.sr_no).css('text-align', 'right'));
                row.append($('<td>').text(modaldata.parti).css('text-align', 'left'));
                row.append($('<td>').text(modaldata.number).css('text-align', 'right'));
                row.append($('<td>').text(modaldata.length).css('text-align', 'right'));
                row.append($('<td>').text(modaldata.breadth).css('text-align', 'right'));
                row.append($('<td>').text(modaldata.height).css('text-align', 'right'));
                row.append($('<td>').text(modaldata.formula).css('text-align', 'left'));
                row.append($('<td>').text(modaldata.qty).css('text-align', 'right'));
...
tableBody.append(row);
             ...
             $('#viewpercentage'+bItemId).val(response.percentage.toFixed(2));
...
$('#itemNo' + bItemId).text(concatenatedValue);
        ...
        error: function (xhr, status, error) {
            ...
            icon: 'error',
            title: 'Oops...',
            text: 'No Measurement found for the given Tender Item!',
...
function displayFinalBillAlert(finalBill) {
        if (finalBill == 1) {
            // Display SweetAlert if it's the final bill
            Swal.fire({
                title: 'Final Bill',
                text: 'This is the final bill and all tender items are already added. Do you still want to add an item?',
                icon: 'info',
                showCancelButton: true,
                confirmButtonText: 'Yes',
                cancelButtonText: 'No'
            ...
            openModaltnditem();
            // Handle the case where final_bill is not equal to 1
            // For example:
            console.log('Not the final bill. Proceed with adding tender items.');
        }
    }
...
function  addallmeasurement()
{
  ...
  $.ajax({
    ...
    success: function(response) {
   console.log(response);
console.log(response.Alldata.InsertDataCount);
   console.log(response.Alldata.checkTotalRow);
    //    var InsertedMeas=response.InsertDataCount;

   document.getElementById("spinner").style.display = "none"; // Hide spinner
   var titleText, iconType;
 if(response.Alldata.InsertDataCount == response.Alldata.checkTotalRow) {
        titleText = 'All measurements added Successfully.';
        iconType = 'success'; // Error icon
    }
    else {
        titleText = response.Alldata.InsertDataCount + ' measurements out of ' + response.Alldata.checkTotalRow + ' added successfully!<br> For remaining measurements kindly check measurements dates in excel';
        iconType = 'error'; // Success icon
    }
    Swal.fire({
        icon: iconType, // Set the icon based on condition
        title: titleText,
    ...
    if (itemResponseArray.length > 0) {
      ...
      for (var i = 0; i < itemResponseArray.length; i++) {
        ...
        // newRow.append($('<td>').text(itemResponse.qty || ''));
                newRow.append($('<td>').text(itemResponse.sr_no || '').css('text-align','right'));
        newRow.append($('<td>').text(itemResponse.parti || '').css('text-align','left'));
        newRow.append($('<td>').text(itemResponse.number || '').css('text-align', 'right'));
        newRow.append($('<td>').text(itemResponse.length || '').css('text-align', 'right'));
        newRow.append($('<td>').text(itemResponse.breadth || '').css('text-align', 'right'));
        newRow.append($('<td>').text(itemResponse.height || '').css('text-align', 'right'));
        newRow.append($('<td>').text(itemResponse.formula || '').css('text-align', 'left'));
        newRow.append($('<td>').text(itemResponse.qty || '').css('text-align', 'right'));
  ...
  if (notForPayment == 1) {
    ...
    checkbox.prop('checked', true);
             ...
             $('#previousQty'+bItemId).val(previousbillqty.toFixed(3));
              $('#currentQty'+bItemId).val(currqty);
             $('#totalQty'+bItemId).val(totalqty);
...
$('#itemNo1' + bitemid).text(concatenatedValue);
  ...
  $('#previousQty'+bitemid).val(previousbillqty.toFixed(3));
              $('#currentQty'+bitemid).val(curqty);
             $('#totalQty'+bitemid).val(exeqty);
  ...
  newRow.append($('<td>').append(checkbox));
      ...
      $('#embeditbutton'+bitemid).modal('show');
          //
          $('#tndqty'+bitemid).val(response.tndqty);
             $('#percentage'+bitemid).val(response.percentage);
             $('#tndcost'+bitemid).val(response.tndcostitem);

             $('#costdifference'+bitemid).val(response.costdifference);
             $('#totalcost'+bitemid).val(response.totlcostitem);
...
function submitManualEntry(bitemid) {
 ...
 var domValue = $('#newdom' + bitemid).val();

// If DOM is empty, prompt the user to provide the value
if (!domValue.trim()) {
    alert('Please provide the Date of Measurement.');
    return; // Exit the function if DOM value is not provided
}
  ...
  $.ajax({
    ...
    console.log("meas_id:", measid);
        ...
        // Set the item_desc in the edit form
          // Set the item_desc in the edit form
          $('#length' + measid).val(emb.length).css('text-align','left');   // Assuming the response has a 'length' property
        $('#breadth' + measid).val(emb.breadth).css('text-align','left'); // Assuming the response has a 'breadth' property
        $('#height' + measid).val(emb.height).css('text-align','left');
        $('#formula' + measid).val(emb.formula).css('text-align','left');   // Assuming the response has a 'length' property
        $('#particulars' + measid).val(emb.parti).css('text-align','left'); // Assuming the response has a 'breadth' property
        $('#number' + measid).val(emb.number).css('text-align','left');
        $('#quantity' + measid).val(emb.qty).css('text-align','left');
...
console.log(currqty)
             $('#previousQty'+bitemid).val(previousbqty);
             $('#currentQty'+bitemid).val(currqty);
             $('#totalQty'+bitemid).val(totalqty);

             $('#tndqty'+bitemid).val(tndqty);
             $('#percentage'+bitemid).val(percentage);
