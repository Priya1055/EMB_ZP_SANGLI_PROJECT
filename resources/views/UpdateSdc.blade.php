...
<div class="container">
    <div class="row col-md-6 col-md-offset-3">
            ...
            <form action="{{ url('UpdateSdcRoute/'.$user->SDC_id) }}"  method="POST"  >
            ...
            <div class="container m-2">
                    ...
                    <div class="row m-2">
                        <div class="col-md-5">
                            <label for="divname">Sub Division Name:</label>
                        </div>
                        <div class="col-md-6">
                        <select class="form-control" name="subdivision_name" id="subdivname">
                                    @foreach($SubDivList as $division)
                    ...
                    <div class="row m-2">
                        <div class="col-md-5">
                            <label for="exname_categary">SDC Name: <span id="sdcnm"></span></label>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row m-2">
                        <div class="col-md-5">
                            <label for="ex_name_M">SDC Name Marathi: <span id="msdcnm"></span></label>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="sdc_name_M" id="sdc_name_M" required value="{{ $user->name_m ?? '' }}">                        </div>
                    </div>
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                        <input type="tel" name="user_name" class="form-control" placeholder="123 456 7890" id="phone" onkeyup="validatephone()" value="{{ $user->user_name ?? '' }}">                        </div>
                    </div>
