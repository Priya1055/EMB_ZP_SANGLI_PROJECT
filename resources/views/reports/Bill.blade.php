...
<div class="container-fluid" >
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="{{ url('BILL', $embsection2->t_bill_Id ?? '') }}">Bill Report</a></li>
        </ul>


        <h2>Bill Statement</h2> 
          <div class="d-flex justify-content-end mb-4 " style="text-align:right; ">
            <a class="btn btn-primary" style="background-color: #ffb7b5; color:black; font-weight:bold; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3);" href="{{ url('billreportpdf', $embsection2->t_bill_Id ?? '') }}">Export to PDF</a>
            </div>
