...
<style>
    ...
    .form-check-input:checked {
       ...
       @media (max-width: 767px) {
        ...
        .mobile-separate th:first-child,
        .mobile-separate td:first-child {
            display: inline-block;
            width: 50%; /* Adjust width as needed */
        }

        .mobile-separate th:nth-child(2),
        .mobile-separate td:nth-child(2) {
            display: inline-block;
            width: 50%; /* Adjust width as needed */
        }
    }
...
<div class="card" id="backbglogo"  >
    <div class="card-header">
        <h5 class="card-title">Checklist for Sectional Engineer</h5>
    </div>
