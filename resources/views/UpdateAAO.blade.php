...
<div class="container">
  ...
  <form action="{{ url('updateAAORoute/'.$user->DAO_id) }}" method="post" required>
  ...
  @csrf
                    ...
                    <div class="row m-2">
                        ...
                        <select class="form-control" name="subname" id="exname_categary"  style='width:100px;'>
                                    ...
                                    <option value="Mrs" {{ $user->subname == 'Mrs' ? 'selected' : '' }}>Mrs</option>
                                </select>
                                <input type="text" class="form-control" name="name" id="name" required value="{{ $user->name ?? '' }}">                        </div>
                    </div>
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="AAO_M" id="AAO_M"  value="{{ $user->name_m ?? '' }}">                        </div>
                    </div>
        ...
        @endforeach
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                        <input type="tel" name="user_name" class="form-control" placeholder="123 456 7890" id="phone" onkeyup="validatephone()" value="{{ $user->username ?? '' }}" required>                        </div>
                    </div>
