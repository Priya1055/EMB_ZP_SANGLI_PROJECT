...
<div id="loader" style="display: none;">Loading...</div>
 ...
 <!-- <div class="container"> -->
  ...
  @if(isset($DStnditems))
                            ...
                            <tr>
                              <td class="item-no text-right">{{ $DStnditem->t_item_no }}</td>
                              <td class="item-subno text-left">{{ $DStnditem->sub_no }}</td>
                              <td class="item-description text-left">{{ $DStnditem->item_desc }}</td>
                              <td class="item-tndQty text-right">{{ $DStnditem->tnd_qty }}</td>
                              <td class="item-Unit text-left">{{ $DStnditem->item_unit }}</td>
                              <td class="item-tndrt text-right">{{ $DStnditem->tnd_rt }}</td>
                              <td class="item-Amount text-right">{{ $DStnditem->t_item_amt }}</td>
                              <td>
        <!-- <a href="{{url('editworkmasterroute/'.$DStnditem->t_item_id )}}" class="btn btn-primary btn-sm">Edit</a> -->
         <button class="btn btn-primary edit-button" data-row-id="{{ $DStnditem->t_item_id }}"><i class="fa fa-pencil" style="color:white;"></i></button>
      </td>
      <td>
    <button class="btn btn-danger delete-button" data-item-id="{{ $DStnditem->t_item_id }}"><i class="fa fa-trash" aria-hidden="true"></i></button>
</td>
