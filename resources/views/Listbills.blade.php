              ...
              @auth 
                  ...
                  @if(auth()->user()->usertypes === "SO" && (int)$mbstatus === 2) 
                          ...
                          <div class="wizard-progressSO">  
                                <div class="step complete avatar" data-step-value="1">Mat Cons  
                                <div class="node"></div>
                                <span class="tip" style="font-size:15px;">Material Consumption</span>
                                </div>  
                                <div class="step complete avatar" data-step-value="2">Recovery
                                <div class="node"></div>
                                <span class="tip" style="font-size:15px;">Recovery</span>
                                </div>   
                                <div class="step complete avatar" data-step-value="3">Excess
                                <div class="node"></div>   
                                <span class="tip" style="font-size:15px;">Excess Saving</span>
                                </div>  
                                <div class="step complete avatar" data-step-value="4"> Royalty
                                <div class="node"></div>  
                                <span class="tip" style="font-size:15px;">Royalty consumption</span>
                                </div>
                                <div class="step complete avatar" data-step-value="5">Upload
                                <div class="node"></div>
                                <span class="tip" style="font-size:15px;">Upload Photo/Doc/Vdo</span>
                                </div>
                                <div class="step complete avatar " data-step-value="6"> Abstract
                                <div class="node"></div>
                                <span class="tip" style="font-size:15px;">Abstract</span>
                                </div>
                                <div class="step complete avatar" data-step-value="7">MB Chk
                                <div class="node"></div>
                                <span class="tip" style="font-size:15px;">MB Checked/Submited</span>
                                </div>
                          </div>
                          <br>
                  ...
                  @else
                          <div class="wizard-progress mb-2">
                                          <div class="step complete avatar" data-step-value="1">
                                            Bill
                                            <div class="node"></div>
                                            <span class="tip" style="font-size:15px;">Bill</span>
                                          </div>

                                          <div class="step complete avatar" data-step-value="2">
                                            MB
                                            <div class="node"></div>
                                            <span class="tip" style="font-size:15px;">MB</span>
                                          </div>

                                          <div class="step complete avatar" data-step-value="3">
                                          SO
                                            <div class="node"></div>
                                            <span class="tip" style="font-size:15px;">SO</span>
                                          </div>

                                          <div class="step complete avatar" data-step-value="4">
                                            DE 
                                            <div class="node"></div>
                                            <span class="tip" style="font-size:15px;">DYE</span>
                                          </div>


                                          <div class="step complete avatar" data-step-value="5">
                                            EE
                                            <div class="node"></div> 
                                            <span class="tip" style="font-size:15px;">EE</span>

                                          </div>

                                          <div class="step complete avatar" data-step-value="6">
                                            Agcy
                                            <div class="node"></div>
                                            <span class="tip" style="font-size:15px;">Agency</span>
                                            </div>


                                            <div class="step complete avatar" data-step-value="7">
                                            SO
                                            <div class="node"></div>
                                            <span class="tip" style="font-size:15px;">SO</span>
                                          </div>

                                          <div class="step complete avatar" data-step-value="8">
                                            SDC
                                            <div class="node"></div>
                                            <span class="tip" style="font-size:15px;">SDC</span>
                                          </div>

                                          <div class="step complete avatar" data-step-value="9">
                                            DE 
                                            <div class="node"></div>
                                            <span class="tip" style="font-size:15px;">DYE</span>
                                          ...
                                          <div class="step complete avatar" data-step-value="10">
                                            PO
                                            <div class="node"></div>
                                            <span class="tip" style="font-size:15px;">PO</span>
                                          </div>

                                          <div class="step complete avatar" data-step-value="11">
                                            Audt
                                            <div class="node"></div>
                                            <span class="tip" style="font-size:15px;">Auditor</span>
                                          </div>


                                          <div class="step complete avatar" data-step-value="12">
                                            AAO
                                            <div class="node"></div> 
                                            <span class="tip" style="font-size:15px;">Accountant</span>

                                          </div>

                                          <div class="step complete avatar" data-step-value="13">
                                            EE
                                            <div class="node"></div> 
                                            <span class="tip" style="font-size:15px;">EE</span>
                                          </div>
...
@endauth 
                    ...
                    <table class="table table-striped"  >
                        ...
                        @foreach($billdata as $bill)
                           ...
                           <form action="{{ url('viewbill' , ['id' =>$bill->t_bill_Id ])}}" method="GET">
                                    @csrf
                                    <div class="avatar">
                                  <button type="submit" class="emb-button mb-2"   style="border: none; background: none;">
                                      <i class="fa fa-eye" aria-hidden="true" style="color:black;font-size:25px;"></i>
                                  </button>
                                  <span class="tip" style="font-size:15px;">VIEW BILL</span></div>
                                  </form>
                                  ...
                                  <div class="avatar">
                                  <button type="submit" class=" mb-2"   style="border: none; background: none;">
                                      <i class="fa fa-pencil"  style="color: black; font-size: 25px;"></i>
                                  </button>
                                  <span class="tip" style="font-size:15px;">Edit Bill</span></div>
   ...
   {{ $bill->is_current === 0 ? 'disabled' : '' }} title="DELETE BILL">
    <i class="fa fa-trash" aria-hidden="true"></i>
                                  ...
                                  <div class="avatar">
                                  <button type="submit" class="btn btn-danger mb-2"    style="border: none; background: none;">
                                      <i class="fa fa-trash" aria-hidden="true" style="color:red;font-size:25px;"></i>
                                  </button>
                                  <span class="tip" style="font-size:15px;">Delete</span></div>
                                ...
                                <form method="post" action="{{ url('updatematerialcon') }}" >
                                    ...
                                    <div  class="avatar">
                                    <button type="submit" style="border: none;" class="material-symbols-outlined" >stacks 
                                    </button>
                                    <span class="tip" style="font-size:15px;">Material Consumption</span>
                                  </div>
                                    @endif
                                ...
                                @endif
                                  ...
                                  <form method="get" action="{{ url('ListRecoveryStatement') }}" >
                                    ...
                                    <input type="hidden" name="t_bill_Id" value="{{ $bill->t_bill_Id }}">
                                    <div class="avatar">
                                    <button type="submit" class="material-symbols-outlined" style="border:none;"  >move_up
                                      </button>
                                      <span class="tip" style="font-size:15px;">Recovery</span></div>
                                  ...
                                  <form action="{{ url('ExcessStatement' , ['id' =>$bill->t_bill_Id ])}}" method="GET">
                                   ...
                                   style="border:none;">
                                    savings</button>
                                   <span class="tip" style="font-size:15px;">Excess Saving</span></div>
                                   @endif
                                   </form>
                                   @endif
                            ...
                            <form method="post" action="{{ url('royaltycons') }}" >
                                ...
                                <input type="hidden" name="workid" id="workid"  value="{{$embsection1->Work_Id ?? ''}}">
                                <div class="avatar">
                                <button type="submit" class="material-symbols-outlined" style="border:none;">payments</button>
                                <span class="tip" style="font-size:15px;">Royalty Comsumptions</span></div>
                                @endif
                              </div>
                            </form>
                            @endif
      ...
      <div class="avatar">
      <a href="#" class="material-symbols-outlined" style="color:black;" onclick="uploadimages();" id="imgButton" >
      upload_file</a>
      <span class="tip" style="font-size:15px;">Upload File</span></div>
        @endif
         </div>
      @endif
...
<form action="{{ url('Abstract' , ['id' =>$bill->t_bill_Id ])}}" method="GET">
                              ...
                              <div class="avatar">
                                   <button type="submit"  class="material-symbols-outlined"  style="border:none;">
                                   credit_card_gear          
                                  </button>
...
<div class="avatar">
<a href="{{ url('emb', ['id' => $bill->t_bill_Id]) }}" style="border:none;color:black"  class=" material-symbols-outlined {{$bill->is_current === 0 ? 'disabled' : ''}}"  >
    analytics
</a>
<span class="tip" style="font-size:15px;">EMB</span></div>

@endif
</div>

<div class="vertical-inline">
<div style="margin-bottom: 10px; margin-left: 10px;" class="avatar" >
        <a href="{{ url('report', ['id' => $bill->t_bill_Id]) }}"  >
             <i class="fa-solid fa-file fa-beat-fade" style="border:none;color:black;font-size:35px;" ></i>
             <span class="tip" >REPORT</span>
        </a>
</div>                                 
   ...
   @if($bill->final_bill == 1 && $mbstatus == 13 && auth()->user()->usertypes === "SO")
    <div style="margin-top: 10px;"  > <!-- Add margin-top to move the button to the next line -->
        <button class="btn btn-group-lg btn-outline-dark btn-close-white btn-dark text-white text-bold " id="WHOCm0dal" data-toggle="modal" data-target="#uploadModal">
          <b>Upload Work HandOver Certificate</b></button>
    </div>
    @endif
    @endauth
  </div>
                          ...
                          <div class="d-flex justify-content-center align-items-center">
                              <form id="yourFormId" method="post" action="{{ url('RouteCheckListSO') }}">
                                  ...
                                  <div class="d-flex justify-content-center align-items-center" id="mbbutton">
                                                                            @if((int)$bill->is_current !== 0)
                                      <div class="avatar">
                                      <button type="submit" class="avatar  material-symbols-outlined "  style="border:none;font-size: 35px;"
                                       id="goToEMBBtn"  data-tooltip="CheckList">
                                          fact_check
                                      </button>
                                      <span class="tip" >CheckList</span>
 ...
 <!-- Hidden input for t_bill_Id -->
                  <input type="hidden" id="rabillid" name="t_bill_Id" value="{{$tbillid}}">
                            ...
                            <label for="photo2" class="font-weight-bold">Photo 2:</label>
                                <input type="file" class="form-control image-input" id="newphoto2" name="photo2" accept="image/jpeg, image/jpg" capture>                               
                            ...
                            <label for="photo3" class="font-weight-bold">Photo 3:</label>
                                <input type="file" class="form-control image-input" id="newphoto3" name="photo3" accept="image/*" capture="camera">                               
...
<!-- For mobile devices -->
<!--<div id="mobileInputs" class="mobile-inputs">-->
<!--    <input type="file" accept="image/*" capture="environment" id="newphoto5capture" name="photo5capture" accept="image/jpeg, image/jpg">-->
<!--                                    <img id="previewPhoto5capture" src="" alt="Previous Photo5capture" style="max-width: 100px; max-height: 100px;">-->
<!--                                    <span class="delete-btn" style="cursor: pointer;" data-target="photo5" data-preview="#previewPhoto5capture" onclick="deleteFile(this)">❌</span>-->
<!--    <label for="cameraPhoto">Capture Photo</label>-->

<!--    <input type="file" accept="image/*" id="newphoto5" name="photo5" accept="image/jpeg, image/jpg">-->
<!--    <label for="filePhoto">Choose File</label>-->
<!--</div>-->

<!-- For non-mobile devices -->
<!--<div id="nonMobileInputs" class="non-mobile-inputs">-->
...
$('#previewPhoto5capture').click(function() {
  var previewImageSrc = $(this).attr('src');
  $('.enlarged-image-content').attr('src', previewImageSrc);
  $('.enlarged-image-modal').fadeIn();
});
...
document.addEventListener("DOMContentLoaded", function() {
    // Add event listeners to both mobile input elements
    var cameraPhotoInput = document.getElementById('cameraPhoto');
    var filePhotoInput = document.getElementById('filePhoto');
    var nonMobilePhotoInput = document.getElementById('nonMobilePhoto');
    var previewPhoto = document.getElementById('previewPhoto5');

    cameraPhotoInput.addEventListener('change', function() {
        filePhotoInput.value = ""; // Clear the value of the file input
        nonMobilePhotoInput.value = ""; // Clear the value of the non-mobile input
        displayPreview(this);
    });

    filePhotoInput.addEventListener('change', function() {
        cameraPhotoInput.value = ""; // Clear the value of the camera input
        nonMobilePhotoInput.value = ""; // Clear the value of the non-mobile input
        displayPreview(this);
    });

    nonMobilePhotoInput.addEventListener('change', function() {
        cameraPhotoInput.value = ""; // Clear the value of the camera input
        filePhotoInput.value = ""; // Clear the value of the file input
        displayPreview(this);
    });
