    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-header">
                    ...
                    <a href="{{url('viewfindworkmaster')}}" class="btn custom-tooltip" style="margin-right:10px;"><i class="fa-solid fa-magnifying-glass fa-2xl" style="color: #63E6BE;" data-toggle="tooltip" title="Find Workid"></i></a>
                                <!-- //new button ajax -->
                                <!-- <a class="btn btn-primary btn-lg" id="newButton">New</a> -->
                        @if(auth()->user()->usertypes === "SO")
                        <a class="btn custom-tooltip" style="bgcolor: #5783db;" id="newButton" onclick="NewWorkIdCreated(null)" ><i class="fa-solid fa-plus fa-2xl" style="color: #B197FC;" data-toggle="tooltip" title="New Workid Create"></i><b></b></a>
                        @endif
                                <!-- //new button ajax -->
            </div>
</div>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                           ...
                           <td>{{ $user->Tot_Exp }}</td>
                                ...
                                <td>
                                <a href="{{url('showworkmaster/' . $user->Work_Id)}}" class="custom-tooltip" style="border-right: 1px solid black; outline: none; display: block; margin-top:5px; border-right: 1px solid black;"><i class="fa fa-eye custom-icon fa-xl" data-toggle="tooltip" title="View Workmaster" style="color: black;"></i><b></b></a>
