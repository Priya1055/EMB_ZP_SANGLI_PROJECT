...
#backbglogo
    {
      background-image: url('{{ asset('Uploads/Photos/zp-sangli1.png') }}');
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
                ...
                <a class="dropdown-item" href="{{url('userpermision')}}">User Permission</a> -->
        ...
        <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="dropdownMenu3" role= "button" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">
                TRANSACTIONS
            </a>
           <div class="dropdown-menu" aria-labelledby="dropdownMenu3">
            <a  class="dropdown-item" href="{{url('listworkmasters')}}">Work Master</a>
            <!--<a  class="dropdown-item" href="{{url('listemb')}}">E-MB</a>-->
            <!-- <a  class="dropdown-item" href="{{url('qrcode')}}">QR code</a> -->

          </div> 
        </li>

<!--        <li class="nav-item dropdown">-->
<!--  <a class="nav-link" href="#" id="dropdownMenu4" role="button" data-toggle="modal" data-target="#exampleModal"-->
<!--     aria-haspopup="true" aria-expanded="false">-->
<!--      REPORTS-->
<!--  </a>-->
<!--</li>-->
        ...
        <li  class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="dropdownMenu4" role= "button" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">
                                    {{ Auth::user()->name }}
                                </a>
