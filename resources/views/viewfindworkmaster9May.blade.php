...
<input type="text" id="work_id_value" name="work_id_value" class="form-control" placeholder="Enter WorkId" style="width: 500px;"> 
                ...
                <div class="form-group col-lg-2">
                    ...
                    <div class="form-group col-lg-5">
                    <select name="fhcode_value" id="fhcode_value" class="form-control" style="width:600px">
            ...
            @endforeach
                ...
                <div class="form-group col-lg-2">
                    ...
                    <div class="form-group col-lg-5">
                    <select name="subdiv_value" class="form-control" id="subdiv_value" style="width:600px">
            ...
            @endforeach
                ...
                <div class="form-group col-lg-2">
                    ...
                    <div class="form-group col-lg-5">
                    <select name="agency_value" id="agency_value" class="form-control" style="width:600px">
...
<div class="form-group col-lg-5">
<input type="text" id="work_NM_value" name="work_NM_value" class="form-control" placeholder="Enter Name of Work" style="width: 500px;"> 
</div>
                </div>
