...
public function tenderitemedit(Request $request)
{
 ...
 $bill_item=DB::table('bil_item')->where('b_item_id' , $bitemid)->get();
 //dd($bill_item);
...
// dd($reduceddata);
 ...
 '<strong>Bill No:</strong> ' . $tbilldata->t_bill_No . '&nbsp;&nbsp;&nbsp;' .
 '<strong>Total Uptodate Amount:</strong> <span style="color: #D21F3C; font-weight: bold;">'. $billtemdata->b_item_amt . '</span>&nbsp;&nbsp;&nbsp;' .
 '<strong>Current Bill Amount:</strong> <span style="color: #D21F3C; font-weight: bold;">' . $tbilldata->curr_grossamt . '</span>&nbsp;&nbsp;&nbsp;' .
'</div></div>';
                ...
                //dd($cabeffect);
                      ...
                      //     dd($billamtro);
                          ...
                          if ($cbillamtro > 0.50) {
                           ...
                           '<strong>Fund Head Code:</strong> ' . $workmasterdetail->F_H_Code . '&nbsp;&nbsp;&nbsp;' .
                           '<strong>Bill No:</strong> ' . $tbilldata->t_bill_No . '&nbsp;&nbsp;&nbsp;' .
                           '<strong>Total Uptodate Amount:</strong> <span style="color: #D21F3C; font-weight: bold;">'. $bitemdata->b_item_amt . '</span>&nbsp;&nbsp;&nbsp;' .
                           '<strong>Current Bill Amount:</strong> <span style="color: #D21F3C; font-weight: bold;">' . $tbilldata->c_netamt . '</span>&nbsp;&nbsp;&nbsp;' .
                           '</div></div>';
...
// if ($existingDesc !== null) {
 ...
 // Update the 'item_desc' column with the new data
//  DB::table('embs')
//      ->where('b_item_id', $measdata->b_item_id)
//      ->update(['parti' => $particulars]);
// // }
...
$billrt=DB::table('bil_item')->where('b_item_id' , $bitemId)->value('bill_rt');
   ...
   '<strong>Fund Head Code:</strong> ' . $workmasterdetail->F_H_Code . '&nbsp;&nbsp;&nbsp;' .
   '<strong>Bill No:</strong> ' . $tbilldata->t_bill_No . '&nbsp;&nbsp;&nbsp;' .
   '<strong>Total Uptodate Amount:</strong> <span style="color: #D21F3C; font-weight: bold;">'. $biltemdata->b_item_amt . '</span>&nbsp;&nbsp;&nbsp;' .
   '<strong>Current Bill Amount:</strong> <span style="color: #D21F3C; font-weight: bold;">' . $tbilldata->c_netamt . '</span>&nbsp;&nbsp;&nbsp;' .
...
public function excelsubmit(Request $request)
{
    ...
    $request->validate([
        'excelFile' => 'required|mimes:xls,xlsx|max:2048', // Add any validation rules you need
    ]);
 ...
 //dd($uploadedFile);
    ...
    // Store the file in a public storage disk
   // $filePath = $uploadedFile->store('excel' . $timestamp, 'public');
//dd($filePath);
    ...
    public function submiteditrcbill(Request $request , $rcmbrid)
    {
        ...
        //dd($stldata);
            ...
            <div class="row">
               ...
               <div class="col-md-1">
               <div class="form-group">
                  <button type="button" class="btn btn-primary btn-sm editrcmbr-button" data-rcbillid="' . $member->rc_mbr_id . '" id="editrccmbr ' .$bitemId.'" title="EDIT RCC MEMBER"><i class="fa fa-pencil-square-o" aria-hidden="true" ></i></button>
               </div>
          </div>
        </div>
