...
$this->lastupdatedRecordData[$itemdata->b_item_id] = [
 ...
 //Image........
    ...
    $html .= '<thead>';
    $html .= '<tr>';
    $html .= '<th style="border: 1px solid black; padding: 5px;  width: 50%;"> Checked measurements ' . $embsection2->EEChk_percentage . '% . (Value Rs .' . $embsection2->EEChk_Amt . ')</th>';
...
$html .= '<th style="border: 1px solid black; padding: 5px; background-color: #f2f2f2; ">Unit</th>';
 ...
 //Image........
    ...
    $html .= '<thead>';
    $html .= '<tr>';
    $html .= '<th style="border: 1px solid black; padding: 5px;  width: 50%; text-align: left;"> Checked measurements  ' . $embsection2->EEChk_percentage . '% . (Value Rs .' . $embsection2->EEChk_Amt . ')</th>';
    $html .= '<th style="border: 1px solid black; padding: 5px; width: 50%;">';
    $html .= '<div style=" width: 150px; height: 60px; display: inline-block;"> <img src="' . $imageSrc3 . '" alt="Base64 Encoded Image" style="width: 100px; height: 60px;"></div>';
    $html .= '<div style="line-height: 1; margin: 0;"><strong>' . $sign3->name .'</strong></div>';
    $html .= '<div style="line-height: 1; margin: 0;"><strong>' . $designation .'</strong></div>';
...
$paymentInfo = "$workid" . PHP_EOL . "$startPageNumber-$totalFooterPages" . PHP_EOL . "$billinfo->Bill_Dt";
...
$dyesubdivision=DB::table('subdivms')->where('Sub_Div_Id' , $sign->subdiv_id)->value('Sub_Div');
    ...
    foreach ($billitems as $itemdata) {
        ...
        if (
            ...
            $abstractreport .= '<td style="border: 1px solid black; padding: 8px; width: 8%; text-align: right; word-wrap: break-word;">' . $itemdata->bill_rt . '</td>';
            $abstractreport .= '<td style="border: 1px solid black; padding: 8px; width: 8%; text-align: right; word-wrap: break-word;">' . $itemdata->b_item_amt . '</td>';
            $abstractreport .= '<td style="border: 1px solid black; padding: 8px; width: 8%; text-align: right; word-wrap: break-word;">' . $itemdata->cur_amt . '</td>';
            // if (isset($lastrecdata[$bitemId])) {
...
if ($abpc !== '0.00' && $abobelowatper !== 'At Per') {
    ...
    $abstractreport .= '<td style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->part_a_amt . '</strong></td>';
    $abstractreport .= '<td style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->c_part_a_amt . '</strong></td>';
...
if ($abpc !== '0.00' && $abobelowatper !== 'At Per') {
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->a_b_effect . '</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->c_abeffect . '</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->gst_base . '</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->c_gstbase . '</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     $abstractreport .= '</tr>';
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->gst_amt . '</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->c_gstamt . '</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     $abstractreport .= '</tr>';
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->part_a_gstamt . '</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->c_part_a_gstamt . '</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     $abstractreport .= '</tr>';
     }
     //$abstractreport .= '</tbody></table>'; 
    ...
    //  $abstractreport .= '<th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;  text-align:center; width: 21%; word-wrap: break-word;">Record Entry No</th>';
        ...
        $bitemid=$roylabitem->b_item_id;
                ...
                //dd($itemid);
                    ...
                    )
                    {
                        ...
                        $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;">' . $roylabitem->bill_rt . '</td>';
                        $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;">' . $roylabitem->b_item_amt . '</td>';
                        $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;">' . $roylabitem->cur_amt . '</td>';
                        // if (isset($lastrecdata[$bitemid])) {
                        //     $abstractreport .= '<td style="border: 1px solid black; padding: 8px; width: 20%; word-wrap: break-word; text-align: center;">Bill</td>';
                        // } elseif (isset($recdata[$bitemid])) {
                        //     $abstractreport .= '<td style="border: 1px solid black; padding: 8px; width: 20%; word-wrap: break-word; text-align: center;">' . $recdata[$bitemid]['Record_Entry_No'] . '</td>';
     ...
     $abstractreport .= '<tr>'; 
     $abstractreport .= '<td colspan="5" style="border: 1px solid black; padding: 8px; width: 64%; text-align:right; word-wrap: break-word;"><strong>Total Part B Amount</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->part_b_amt . '</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->c_part_b_amt . '</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     $abstractreport .= '</tr>';
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->bill_amt_gt . '</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->c_billamtgt . '</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     $abstractreport .= '</tr>';
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->bill_amt_ro . '</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->c_billamtro . '</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     $abstractreport .= '</tr>';
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->net_amt . '</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->c_netamt . '</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     $abstractreport .= '</tr>';
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->p_net_amt . '</strong></td>';
    ...
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $nowpayamounttotal . '</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>'.$nowpayamountcurrent.'</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     $abstractreport .= '</tr>';
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->p_tot_ded . '</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->tot_ded . '</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     $abstractreport .= '</tr>';
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->p_tot_recovery . '</strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $tbilldata->tot_recovery . '</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     $abstractreport .= '</tr>';
     ...
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong></strong></td>';
     $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 8%; text-align:right; word-wrap: break-word;"><strong>' . $chequeamtcurrent . '</strong></td>';
    //  $abstractreport .= '<td  style="border: 1px solid black; padding: 8px; width: 20%; "></td>';
     $abstractreport .= '</tr>';
...
// $imageSrc2 = 'data:image/jpeg;base64,' . $imageData2;
    ...
    foreach($billitems as $bilitem)
    {
      ...
      // dd($billdata);
        ...
        $excessreport .= '<td style="border: 1px solid black; padding: 8px; text-align:right;">' . $tnddata->tnd_rt . '</td>';
        $excessreport .= '<td style="border: 1px solid black; padding: 8px; text-align:right;">' . $tnddata->t_item_amt . '</td>';
        $excessreport .= '<td style="border: 1px solid black; padding: 8px; text-align:right;">' . $bilitem->exec_qty . '</td>';
        $excessreport .= '<td style="border: 1px solid black; padding: 8px; text-align:right;">' . $bilitem->bill_rt . '</td>';
        $excessreport .= '<td style="border: 1px solid black; padding: 8px; text-align:right;">' . $bilitem->b_item_amt . '</td>';
...
if ($resultAmount > 0) {
    ...
    $excessreport .= '<td style="border: 1px solid black; padding: 8px; text-align:right;">' . number_format($savingAmount , 2) . '</td>';
} elseif($resultAmount < 0) {
    $excessreport .= '<td style="border: 1px solid black; padding: 8px; text-align:right;">' . number_format($excessQuantity , 3) . '</td>';
    $excessreport .= '<td style="border: 1px solid black; padding: 8px; text-align:right;">' . number_format($excessAmount , 2) . '</td>';
    $excessreport .= '<td style="border: 1px solid black; padding: 8px; text-align:right;">0</td>';
    $excessreport .= '<td style="border: 1px solid black; padding: 8px; text-align:right;">0</td>';
}
else
{
    ...
    $excessreport .= '<td colspan="2" style="border: 1px solid black; padding: 8px; text-align:right; width: 8%; font-weight: bold;">' . $totalTItemAmt . '</td>';
    $excessreport .= '<td colspan="3" style="border: 1px solid black; padding: 8px; text-align:right; width: 8%;"></td>';
    $excessreport .= '<td colspan="2" style="border: 1px solid black; padding: 8px; text-align:right; width: 8%; font-weight: bold;">' . $totalExcessAmount . '</td>';
    $excessreport .= '<td colspan="2" style="border: 1px solid black; padding: 8px; text-align:right; width: 8%; font-weight: bold;">' . $totalSavingAmount . '</td>';
    $excessreport .= '<td colspan="3" style="border: 1px solid black; padding: 8px; text-align:right; width: 6%; font-weight: bold;">' . $netEffect . '</td>';
    $excessreport .= '</tr>';
...
$excessreport .= '</table></div>';
    ...
    $excessreport .= '<thead>';
    $excessreport .= '<tr>';
    $excessreport .= '<th style="border: 1px solid black; padding: 5px; background-color: #f2f2f2; text-align:center; width: 3%;  word-wrap: break-word;">Sr No</th>';
    $excessreport .= '<th style="border: 1px solid black; padding: 5px; background-color: #f2f2f2; text-align:center; width: 7%;  word-wrap: break-word;">Item of Work</th>';
    $excessreport .= '<th style="border: 1px solid black; padding: 5px; background-color: #f2f2f2; text-align:center; width: 3%;  word-wrap: break-word;">Unit</th>';
    ...
    $excessreport .= '<th style="border: 1px solid black; padding: 5px; background-color: #f2f2f2; text-align:center; width: 4%;  word-wrap: break-word;">Tendered Rate</th>';
    $excessreport .= '<th style="border: 1px solid black; padding: 5px; background-color: #f2f2f2; text-align:center; width: 4%;  word-wrap: break-word;">Tendered Item Amount</th>';
    $excessreport .= '<th style="border: 1px solid black; padding: 5px; background-color: #f2f2f2; text-align:center; width: 4%;  word-wrap: break-word;">Executed Quantity</th>';
    $excessreport .= '<th style="border: 1px solid black; padding: 5px; background-color: #f2f2f2; text-align:center; width: 4%;  word-wrap: break-word;">Allowed Rate</th>';
    $excessreport .= '<th style="border: 1px solid black; padding: 5px; background-color: #f2f2f2; text-align:center; width: 4%;  word-wrap: break-word;">Uptodate Amount</th>';
    ...
    foreach($billitems as $bilitem)
    {
      ...
      // dd($billdata);
        ...
        if ($resultAmount > 0) {
            ...
            $excessreport4 .= '<td style="border: 1px solid black; padding: 1px; text-align:right; width: 1%;  word-wrap: break-word;">' . number_format($savingAmount , 2) . '</td>';
        } elseif($resultAmount < 0) {
            ...
            $excessreport2 .= '<td style="border: 1px solid black; padding: 1px; text-align:right; width: 1%;  word-wrap: break-word;">' . number_format($excessAmount , 2) . '</td>';
        ...
        $excessreport .= '<td style="border: 1px solid black; padding: 2px; text-align:right; width: 4%;  word-wrap: break-word;">' . $tnddata->tnd_rt . '</td>';
        $excessreport .= '<td style="border: 1px solid black; padding: 2px; text-align:right; width: 4%;  word-wrap: break-word;">' . $tnddata->t_item_amt . '</td>';
        ...
        $excessreport .= '<td style="border: 1px solid black; padding: 2px; text-align:right; width: 4%;  word-wrap: break-word;">' . $bilitem->bill_rt . '</td>';
        $excessreport .= '<td style="border: 1px solid black; padding: 2px; text-align:right; width: 4%;  word-wrap: break-word;">' . $bilitem->b_item_amt . '</td>';
    ...
    $excessreport .= '<td colspan="2" style="border: 1px solid black; padding: 4px; text-align:right; width: 4%; font-weight: bold;">' . $totalTItemAmt . '</td>';
    $excessreport .= '<td colspan="3" style="border: 1px solid black; padding: 4px; text-align:right; width: 4%;"></td>';
    $excessreport .= '<td colspan="2" style="border: 1px solid black; padding: 4px; text-align:right; width: 4%; font-weight: bold;">' . $totalExcessAmount . '</td>';
    $excessreport .= '<td colspan="2" style="border: 1px solid black; padding: 4px; text-align:right; width: 4%; font-weight: bold;">' . $totalSavingAmount . '</td>';
    $excessreport .= '<td  style="border: 1px solid black; padding: 4px; text-align:right; width: 5%; font-weight: bold;">' . $netEffect . '</td>';
    $excessreport .= '</tr>';
...
foreach ($RecoverytbillrelatedData as $data)
{
    ...
    $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->Mat_Rt . '</td>';
    $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->Mat_Amt . '</td>';
    $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->UptoDt_m_Qty . '</td>';
    $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->UptoDt_m_Amt . '</td>';
    $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->pre_m_Qty . '</td>';
    $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->pre_M_Amt . '</td>';
    $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->Cur_M_Qty . '</td>';
    $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->Cur_M_Amt . '</td>';
    $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->Bal_M_Qty . '</td>';
    $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->Bal_M_Amt . '</td>';
...
$RecoveryReport .= '</td>';
$RecoveryReport .= '<td colspan="1" style="border: 1px solid black; padding: 8px;  text-align: center; font-weight:bold;">' . $TotalRecovery . '</td>';
...
public function recoveryreport(Request $request , $tbillid)
{
    ...
    foreach ($RecoverytbillrelatedData as $data) {
        ...
        $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px; width: 5%; text-align: right; word-wrap: break-word;">' . $data->Mat_Rt . '</td>';
        $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px; width: 5%; text-align: right; word-wrap: break-word;">' . $data->Mat_Amt . '</td>';
        ...
        $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px; width: 5%; text-align: right; word-wrap: break-word;">' . $data->UptoDt_m_Amt . '</td>';
        ...
        $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px; width: 5%; text-align: right; word-wrap: break-word;">' . $data->pre_M_Amt . '</td>';
        ...
        $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px; width: 5%; text-align: right; word-wrap: break-word;">' . $data->Cur_M_Amt . '</td>';
        ...
        $RecoveryReport .= '<td style="border: 1px solid black; padding: 8px; width: 5%; text-align: right; word-wrap: break-word;">' . $data->Bal_M_Amt . '</td>';
...
$TotalRecovery = number_format($TotalRecovery, 2); // Format total recovery amount to two decimal places
    ...
    $RecoveryReport .= '</td>';
    $RecoveryReport .= '<td colspan="1" style="border: 1px solid black; padding: 8px; max-width: 40%; text-align: center; font-weight:bold;">' . $TotalRecovery . '</td>';
    $RecoveryReport .= '</tr>';
...
$BillReport .= '<tr>';
    ...
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> ' . $DBbillTablegetData->c_part_a_amt.' </td>';
    ...
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> ' . $DBbillTablegetData->c_abeffect.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';
    ...
    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> GST Base	</td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> ' . $DBbillTablegetData->c_gstbase.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';

    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> GST Amount 18%</td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> ' . $DBbillTablegetData->c_gstamt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';

    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> Total </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> ' . $DBbillTablegetData->c_part_a_gstamt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: left; word-wrap: break-word;"></td>';
    ...
    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> Total Part B Amount</td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;">' .  $DBbillTablegetData->c_part_b_amt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';

    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> Grand Total</td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;">' .  $DBbillTablegetData->c_billamtgt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';

    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> Add for rounding off</td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;">' .  $DBbillTablegetData->c_billamtro.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';

    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> Final Total	 </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;">' .  $DBbillTablegetData->c_netamt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';

    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;"> Previously Paid Amount From Per Bill </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: right; word-wrap: break-word;">' .  $DBbillTablegetData->p_net_amt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px; width: 10%; text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';
  ...
  // dd($FirstBill,$FinalBill);
   // $header=$this->commonheader();
    ...
    foreach ($NormalData as $data)
    {
        ...
        $BillReport .= '<td style="border: 1px solid black; padding: 8px; width: 70px; text-align: right; word-wrap: break-word;">' . $data->bill_rt . '</td>';
        $BillReport .= '<td style="border: 1px solid black; padding: 8px; width: 50px; text-align: left; word-wrap: break-word;">' . $data->item_unit . '</td>';
        $BillReport .= '<td style="border: 1px solid black; padding: 8px; width: 70px; text-align: right; word-wrap: break-word;">' . $data->b_item_amt . '</td>';
    ...
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;"> ' . $DBbillTablegetData->c_part_a_amt.' </td>';
    ...
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;"> ' . $DBbillTablegetData->c_abeffect.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';
    ...
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;"> ' . $DBbillTablegetData->c_gstbase.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';

    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;"> GST Amount 18%</td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;"> ' . $DBbillTablegetData->c_gstamt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';

    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;"> Total </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;"> ' . $DBbillTablegetData->c_part_a_gstamt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: left; word-wrap: break-word;"></td>';
    ...
    foreach ($FINALBILL as $data)
    {
        ...
        $BillReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->bill_rt . '</td>';
        $BillReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: left; word-wrap: break-word;">' . $data->item_unit . '</td>';
        $BillReport .= '<td style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $data->b_item_amt . '</td>';
    ...
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' .  $DBbillTablegetData->c_part_b_amt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';

    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;"> Grand Total</td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' .  $DBbillTablegetData->c_billamtgt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';
    ...
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' .  $DBbillTablegetData->c_billamtro.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';

    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=4 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;"> Final Total	 </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' .  $DBbillTablegetData->c_netamt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';
    ...
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' .  $DBbillTablegetData->p_net_amt.' </td>';
    $BillReport .= '<td colspan=1 style="border: 1px solid black; padding: 8px;  text-align: left; word-wrap: break-word;"></td>';
    $BillReport .= '</tr>';
    ...
    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=6 style="border: 1px solid black;  padding: 8px;  text-align: center; word-wrap: break-word;"> Total value of work done or supplies made  ' .  $DBbillTablegetData->c_netamt.'</td>';
    $BillReport .= '</tr>';

    $BillReport .= '<tr>';
    $BillReport .= '<th colspan=6 style="border: 1px solid black;  padding: 8px;  text-align: center; word-wrap: break-word;"> In  Word ' .  $amountInWords.' Nil Only </td>';
    $BillReport .= '</tr>';
    $BillReport .= '</thead>';
...
//     $BillReport .= '</table>';
    ...
    else
    {
        ...
        $BillReport .= '<tr>';
        $BillReport .= '<td style="width: 100%; text-align: justify; font-size: 96%; padding-left:9%;  word-wrap: break-word;"><b>Account Classification - </b><br> '.$workdata->F_H_Code.'';
        $BillReport .= '</td>';
        ...
        if ($abpc !== '0.00' && $abobelowatper !== 'At Per') {
            ...
            $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->part_a_amt . '</strong></td>';
            $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->c_part_a_amt . '</strong></td>';
        ...
        if ($abpc !== '0.00' && $abobelowatper !== 'At Per') {
            ...
            $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->c_abeffect . '</strong></td>';
            $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->a_b_effect . '</strong></td>';
            $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong></strong></td>';
            $BillReport .= '</tr>';
        }
        ...
        $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->gst_base . '</strong></td>';
        $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->c_gstbase . '</strong></td>';
        $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong></strong></td>';
        $BillReport .= '</tr>';
        ...
        $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->gst_amt . '</strong></td>';
        $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->c_gstamt . '</strong></td>';
        $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong></strong></td>';
        $BillReport .= '</tr>';
        ...
        //dd($RoyaltyData);
         if (!$RoyaltyData->isEmpty()) {
            ...
            $BillReport .= '<td  colspan="1" style="border: 1px solid black;  padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->part_b_amt . '</strong></td>';
            $BillReport .= '<td  colspan="1" style="border: 1px solid black;  padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->c_part_b_amt . '</strong></td>';
            $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong></strong></td>';
            $BillReport .= '</tr>';
            ...
            $BillReport .= '<td colspan="1" style="border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->bill_amt_gt . '</strong></td>';
            $BillReport .= '<td colspan="1" style="border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->c_billamtgt . '</strong></td>';
            $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong></strong></td>';
            $BillReport .= '</tr>';
            ...
            $BillReport .= '<td colspan="1"  style="border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->bill_amt_ro . '</strong></td>';
            $BillReport .= '<td colspan="1"  style="border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->c_billamtro . '</strong></td>';
            $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong></strong></td>';
            $BillReport .= '</tr>';
            ...
            $BillReport .= '<td colspan="1"  style="border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->net_amt . '</strong></td>';
            $BillReport .= '<td colspan="1"  style="border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong>' . $Billinfo->c_netamt . '</strong></td>';
            $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong></strong></td>';
            $BillReport .= '</tr>';
            ...
            $BillReport .= '<td colspan="1" style="border: 1px solid black;  padding: 8px;  text-align: right; word-wrap: break-word;"><strong>' .  $Net_Pre_subtraction.'</strong> </td>';
            $BillReport .= '<td colspan="1" style=" border: 1px solid black; padding: 8px;  text-align:right; word-wrap: break-word;"><strong></strong></td>';
            $BillReport .= '</tr>';
...
public function commonforeach($NormalData,$tbillid,$work_id)
{
    ...
    $BillReport .= '</tr>';
        ...
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px;  text-align:center;  word-wrap: break-word;"></td>';
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px;  text-align:center;  word-wrap: break-word;">TENDER ITEM NO :'.$BillData->t_item_no.'</td>';
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px;  text-align:center;  word-wrap: break-word;"></td>';
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px;  text-align:center;  word-wrap: break-word;"></td>';
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px;  text-align:center;  word-wrap: break-word;"></td>';
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px;  text-align:center;  word-wrap: break-word;"></td>';
        ...
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px;  text-align:right;  word-wrap: break-word;">'.$BillData->bill_rt.'</td>';
        }
        else{
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px;  text-align:right;  word-wrap: break-word;">'.$BillData->bill_rt.'<br>_______________<br>'.$BillData->tnd_rt.'</td>';
        }
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px;  text-align:right;  word-wrap: break-word;">'.$BillData->b_item_amt.'</td>';

        $BillReport .= '<td style=" border: 1px solid black; padding: 8px;  text-align:right;  word-wrap: break-word;">'.$BillData->cur_amt.'</td>';
...
public function commonforeachview($NormalData,$tbillid,$work_id)
{
    ...
    // $BillReport .= '<tbody>';
        ...
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px; background-color: #f2f2f2; text-align:center; width: 55%; word-wrap: break-word;">TENDER ITEM NO :'.$BillData->t_item_no.'</td>';
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px; background-color: #f2f2f2; text-align:center; width: 8%; word-wrap: break-word;"></td>';
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px; background-color: #f2f2f2; text-align:center; width: 8%; word-wrap: break-word;"></td>';
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px; background-color: #f2f2f2; text-align:center; width:8%; word-wrap: break-word;"></td>';
        ...
        if($BillData->bill_rt===$BillData->tnd_rt){
        $BillReport .= '<td style=" border: 1px solid black; padding: 8px; background-color: #f2f2f2; text-align:right; width: 8%; word-wrap: break-word;">'.$BillData->bill_rt.'</td>';
        }
        else{
            $BillReport .= '<td style="border: 1px solid black; padding: 8px; background-color: #f2f2f2; text-align:right; width: 8%; word-wrap: break-word;">'.$BillData->bill_rt.'<br>_______________<br>'.$BillData->tnd_rt.'</td>';
        }
        $BillReport .= '<td style="border: 1px solid black; padding: 8px; background-color: #f2f2f2; text-align:right; width: 8%; word-wrap: break-word;">'.$BillData->b_item_amt.'</td>';

        $BillReport .= '<td style="border: 1px solid black; padding: 8px; background-color: #f2f2f2; text-align:right; width: 8%; word-wrap: break-word;">'.$BillData->cur_amt.'</td>';
        $BillReport .= '</tr>';
...
public function form_xivReport($tbillid ){
    ...
    $EE_nm=DB::table('eemasters')->where('eeid' , $workdata->EE_id)->select('name','subname','designation')->first();
    // $DYE_Design=DB::table('dyemasters')->where('DYE_id' , $workdata->DYE_id)->select('name','designation')->first();
    //dd($DYE_nm);  $DYE_nm->designation
    // $headercheck='Bill';
    $cvno=$Billinfo->cv_no;
 ...
 //dd($rbbillno,$rbbiill);
    ...
    $htmlreport .= '<td colspan=4 style="text-align: left;"> '.$workdata->F_H_Code.' </td>';
    $htmlreport .= '</tr>';
    ...
    $htmlreport .= '<td colspan=2 style="text-align: left;">'.$Billinfo->c_netamt.'   </td>';
    ...
    $htmlreport .= '<td colspan=2 style="text-align: left;"> '.$Billinfo->chq_amt.'</td>';
...
$htmlreport .= '<td colspan=12 style="text-align: left;"> '.$workdata->F_H_Code.'</td>';
$htmlreport .= '</tr>';
...
$htmlreport .= '<td colspan=12 style="text-align: left;">'.$Billinfo->c_netamt.' </td>';
$htmlreport .= '</tr>';

$htmlreport .= '<tr>';
$htmlreport .= '<td colspan=12 style="text-align: left;">9) Net amount of Bill</td>';
$htmlreport .= '<td colspan=12 style="text-align: left;">'.$Billinfo->chq_amt.'</td>';
$htmlreport .= '</tr>';
...
$htmlreport .= '<td  style="text-align: center;"> '.$workdata->F_H_Code.' </td>';
$htmlreport .= '</tr>';
...
$htmlreport .= '<td  style="text-align: right; padding-top: 5px;">'.$Billinfo->c_netamt.'</td>';
...
$htmlreport .= '<td  style="text-align: right; padding-top: 5px;"> '.$Billinfo->chq_amt.'</td>';
...
$htmlreport .= '<tr>';
$htmlreport .= '<td  style="text-align: justify; padding-top: 15px;">Received by cheque/cash Receipt Rs.'.$cash_rs.' For the C.A & F.O.Z.P Sangli.</td>';
$htmlreport .= '</tr>';
...
$htmlreport .= '<p  style="text-align: right; margin-top:50px;"><strong>'.$EE_nm->designation.'</strong><br>'.$workdata->Div.'</p>';
...
public function royaltystatement(Request $request , $tbillid)
{
        ...
        if($roydata->royal_m == 'R')
        {
            ...
            $RoyaltyReport .= '</tr>';
                ...
                foreach($royalRmdatas as $royalRmdata)
                {
                    ...
                    $RoyaltyReport .= '<td  style="border: 1px solid black; padding: 8px;  text-align: right; word-wrap: break-word;">' . $royalRmdata->royal_amt . '</td>';
                    $RoyaltyReport .= '</tr>';
                ...
                $RoyaltyReport .= '<th  style="border: 1px solid black; padding: 8px; background-color: #f2f2f2; text-align: right; word-wrap: break-word;">' . $totalamt . '</th>';
                $RoyaltyReport .= '</tr>';
    ...
    $RoyaltyReport .= '<th  style="border: 1px solid black; padding: 8px; background-color: #f2f2f2; text-align: right; word-wrap: break-word;">' . number_format($ALLtotal , 2) . '</th>';
    $RoyaltyReport .= '</tr>';
...
<div class="table-responsive">
              ...
              <tr>
                  ...
                  <td style="padding-left: 10px; padding-top: 10px;">' . $DBWorkMaster->TS_Amt . '</td>
              </tr>
              <tr>
                  <td style="padding-top: 20px;"><strong>Tendered Cost:</strong></td>
                  <td style="padding-left: 10px; padding-top: 10px;">' . $DBWorkMaster->Tnd_Amt . '</td>
              </tr>
          </table>
...
public function compcertfreportPDF(Request $request , $tbillid)
{
    ...
    $qrCodeString = str_replace('<?xml version="1.0" encoding="UTF-8"?>', '', $qrCode);
        ...
        <h5>[See Rule 190]</h5>
          ...
          <tr>
              <td style="padding-top: 20px;"><strong>Estimated Cost:</strong></td>
              <td style="padding-left: 30px; padding-top: 10px;">' . $DBWorkMaster->TS_Amt . '</td>
          </tr>
          <tr>
              <td style="padding-top: 20px;"><strong>Tendered Cost:</strong></td>
              <td style="padding-left: 30px; padding-top: 10px;">' . $DBWorkMaster->Tnd_Amt . '</td>
          </tr>
      </table>
