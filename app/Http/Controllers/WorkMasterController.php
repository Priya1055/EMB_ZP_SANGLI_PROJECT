...
//    dd($uid);
    ...
    switch($usertype)
    {
        ...
        case 'EE':
            ...
            $workmasterdata=DB::table('workmasters')->where('EE_id' , $userid)->orderBy('workmasters.Wo_Dt', 'desc')->paginate(10);
         ...
         case 'DYE':
            $userid=DB::table('dyemasters')->where('userid' , $uid)->value('dye_id');
             //dd($userid);
            $workmasterdata=DB::table('workmasters')->where('DYE_id' , $userid)->orderBy('workmasters.Wo_Dt', 'desc')->paginate(10);
            //dd($workmasterdata);
            break;   
        ...
        case 'PA':
            //dd($uid);
            $userid=DB::table('dyemasters')->where('userid' , $uid)->value('dye_id');
            $workmasterdata=DB::table('workmasters')->where('PA_Id' , $userid)->orderBy('workmasters.Wo_Dt', 'desc')->paginate(10);
        ...
        case 'SO':
            ...
            //dd($userid);
            $workmasterdata=DB::table('workmasters')->where('jeid' , $userid)->orderBy('workmasters.Wo_Dt', 'desc')->paginate(10);
        ...
        case 'PO':
            $userid=DB::table('jemasters')->where('userid' , $uid)->value('jeid');
            //dd($userid);
            $workmasterdata=DB::table('workmasters')->where('PB_Id' , $userid)->orderBy('workmasters.Wo_Dt', 'desc')->paginate(10);
            //dd($workmasterdata);
        ...
        case 'AAO':
            ...
            //dd($userid);
            $workmasterdata=DB::table('workmasters')->where('DAO_Id' , $userid)->orderBy('workmasters.Wo_Dt', 'desc')->paginate(10);
            //dd($workmasterdata);
        ...
        case 'audit':
            ...
            //dd($userid);
            $workmasterdata=DB::table('workmasters')->where('AB_Id' , $userid)->orderBy('workmasters.Wo_Dt', 'desc')->paginate(10);
            //dd($workmasterdata);
        ...
        case 'SDC':
            ...
            //dd($userid);
            $workmasterdata=DB::table('workmasters')->where('SDC_id' , $userid)->orderBy('workmasters.Wo_Dt', 'desc')->paginate(10);
            //dd($workmasterdata);
            ...
            case 'Agency':
               ...
               // dd($userid);
                $workmasterdata=DB::table('workmasters')->where('Agency_Id' , $userid)->orderBy('workmasters.Wo_Dt', 'desc')->paginate(10);
                //dd($workmasterdata);
